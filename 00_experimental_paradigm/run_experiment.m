...
% Directories
slash = '/';
video_dir = '../stimulus_videos';
metadata_dir = '../stimuli_metadata/annotations.json';
utils_dir = '../EMD/00_experimental_paradigm/utils';
stim_order_dir = '../EMD/00_experimental_paradigm/stimulus_order';
save_dir = '../EMD/00_experimental_paradigm/behavioral_results';
addpath(utils_dir);
