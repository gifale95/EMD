...
#SBATCH --job-name=eye_pair_dec_data_split-train
...
# Run the job
python eye_pairwise_decoding.py --sub $sub --mean_centering $mean_centering --zscore $zscore --features $features --time_split $time_split --pseudo_trials $pseudo_trials --data_split 'train'
