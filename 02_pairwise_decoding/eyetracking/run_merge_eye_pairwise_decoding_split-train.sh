...
#SBATCH --job-name=merge_eye_pairwise_decoding_split-train
...
# Run the job
python merge_eye_pairwise_decoding.py --sub $sub --mean_centering $mean_centering --zscore $zscore --features $features --pseudo_trials $pseudo_trials --data_split 'train' 
