...
#SBATCH --job-name=eeg_moments_pairwise_decoding_data_split-test
...
# Run the job
python pairwise_decoding.py --sub $sub --channels $channels --time_split $time_split --pseudo_trials $pseudo_trials --data_split 'test'
