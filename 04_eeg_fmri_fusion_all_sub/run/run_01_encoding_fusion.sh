...
#SBATCH --job-name=EMD-04_eeg_fmri_fusion_all_sub-01_encoding_fusion
...
# Running the job
python 01_encoding_fusion.py --eeg_time_split $eeg_time_split --fmri_subject $fmri_subject --fmri_hemi $fmri_hemi