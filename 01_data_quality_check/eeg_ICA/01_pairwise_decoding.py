"""Run a pariwise decoding analysis on the EEG responses for the 102 test
videos.
...
data_dir = os.path.join(args.project_dir, 'derivatives', 'eeg_eyeblink_removal',
...
save_dir = os.path.join(args.project_dir, 'results', 'data_quality_check',
    'eeg_ICA', 'pairwise_decoding_rdms')
os.makedirs(save_dir, exist_ok=True)

file_name = f'rdms_sub-{args.subject:02d}_channels-{args.channels}.npy'
