...
#SBATCH --job-name=04_eeg_fmri_fusion-04_plot_encoding_accuracy_train_split
...
# Run the job
python 04_plot_encoding_accuracy_train_split.py --eeg_channel_policy $eeg_channel_policy
