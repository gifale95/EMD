...
fMRI resposnes, independently for each EEG time point, using the train split.
...
# =============================================================================
# Load the recorded training fMRI responses
# =============================================================================
...
file_name = 'sub-' + format(args.fmri_subject, '02') + \
	'_noiseceiling_space-fsaverage_' + 'task-train_hemi-' + args.fmri_hemi + \
	'_n-3.pkl'
f = open(os.path.join(data_dir, file_name), 'rb')
...
data_dir = os.path.join(args.project_dir, 'results', 'eeg_fmri_fusion',
	'eeg_pca', 'eeg_pca_train_channel_policy-'+args.eeg_channel_policy+
...
save_dir = os.path.join(args.project_dir, 'results', 'eeg_fmri_fusion',
	'encoding_accuracy_train_split', 'sfreq-'+format(args.sfreq, '04'),
