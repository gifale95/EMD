...
#SBATCH --job-name=04_eeg_fmri_fusion-03_test_encoding_train_split
...
# Run the job
python 03_test_encoding_train_split.py --fmri_subject $fmri_subject --fmri_hemi $fmri_hemi --eeg_channel_policy $eeg_channel_policy --fmri_split $fmri_split
