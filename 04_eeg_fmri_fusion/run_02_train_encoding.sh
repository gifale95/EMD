...
#SBATCH --job-name=04_eeg_fmri_fusion-02_train_encoding
...
# Run the job
python 02_train_encoding.py --fmri_subject $fmri_subject --fmri_hemi $fmri_hemi --eeg_channel_policy $eeg_channel_policy --fmri_split $fmri_split
