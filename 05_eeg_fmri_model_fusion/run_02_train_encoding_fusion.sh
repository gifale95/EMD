...
#SBATCH --job-name=05_eeg_fmri_model_fusion-02_train_encoding_fusion
...
# Run the job
python 02_train_encoding_fusion.py --fmri_subject $fmri_subject --fmri_hemi $fmri_hemi --eeg_channel_policy $eeg_channel_policy --fmri_split $fmri_split
