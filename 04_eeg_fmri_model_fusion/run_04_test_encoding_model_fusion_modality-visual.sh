...
#SBATCH --job-name=05_eeg_fmri_model_fusion-04_test_encoding_model_fusion_modality-visual
...
# Run the job
python 04_test_encoding_model_fusion.py --fmri_subject $fmri_subject --fmri_hemi $fmri_hemi --eeg_channel_policy $eeg_channel_policy --fmri_split $fmri_split --modality 'visual' --model_name $model_name
